...
dictRegion  = {
                'virginia':  {'srcRegion': 'your-source-region', 'destRegion': 'us-west-2', 'your-destination-region': ["your-database-name"], 'kmsKey': 'arn:aws:kms:us-west-2:123456890:key/123456890-1234-1234-1234-123456890'},
                'dublin' :  {'srcRegion': 'your-source-region', 'destRegion': 'eu-central-1', 'your-destination-region': ["your-database-name", "your-database-name"], 'kmsKey': 'arn:aws:kms:eu-central-1:123456890:key/123456890-1234-1234-1234-123456890' }
            }
